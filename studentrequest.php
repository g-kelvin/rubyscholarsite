...
<body>
	...
	if(isset($_POST['submit'])){
		...
		$subject = 'Students Registration Request'." , ";
		$msg ="Name: ".$fname." ".$lname." ".$oname."  "."School Type: ".$schooltype." , "." School Level: ".$schoollevel." , "."Grade You Are At: ".$grade." ,"." Gender".$gender." , "." Email: ".$email." , "." Telephone Number: ".$telephone;
		$headers ="From: ".$email;
