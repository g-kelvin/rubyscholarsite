                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            <input type="email" placeholder="Email Address" name="email" required maxlength="100" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" placeholder="Estate" maxlength="100" required name="estate" class="form-control">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" placeholder="Tel" name="tel" required maxlength="20" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" maxlength="100" required placeholder="Course" name="course" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" placeholder="Grade" name="grade" required maxlength="20" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" maxlength="100" required placeholder="Address" name="address" class="form-control">
                                        </div>
                                    </div>
