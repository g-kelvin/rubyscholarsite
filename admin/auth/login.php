...
<div
  class="cui-login"
  style="background-image: url(/components/pages/common/img/login/1.jpeg)"
>
      ...
      <div class="col-xl-12">
        <div class="cui-login-block-inner">
          <div class="cui-login-block-form">
            ...
            <div class="row">
              <div class="col-sm-12 alert alert-<?php echo $_SESSION['flash_message_class'] ?>" role="alert">
                <?php echo $_SESSION['flash_message']; ?>
              </div>
            </div>
            <?php } ?>

            <form name="form-validation" action="/admin/api/auth.php" method="POST">
            <input type="hidden" name="request" value="login" />
              ...
              <div class="form-actions">
                <button type="submit" class="btn btn-primary mr-3 btn-fluid">Sign In</button>
  ...
  ;(function($) {
    ...
    $(function() {
      ...
      $('.random-bg-image').on('click', function() {
        ...
        $('.cui-login')
          .data('img', final)
          .css('backgroundImage', 'url(/components/pages/common/img/login/' + final + '.jpeg)')
      })
    })
  })(jQuery)
</script>
