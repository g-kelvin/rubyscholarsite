...
if (isset($_POST['confirmation_code'])) {
    $qry = "SELECT mpesa_confirmation FROM request WHERE tid = '$id'";
    $res = mysqli_query($conn, $qry);
    $data = mysqli_fetch_assoc($res);
    $c = strtoupper($_POST['confirmation_code']);
    if ($data['mpesa_confirmation'] === $c ) {
       $x =  mysqli_query($conn, "UPDATE request SET paid = 'CONFIRMED'");
    ...
    <div class="cui-layout">
        <div class="cui-layout-content">
          ...
          <span class="font-size-18 d-block">
            ...
            <span class="text-muted">Confirm Request</span>
          </span>
            </nav>
                    ...
                    <section class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <h5 class="text-black"><strong>Request Confirmation</strong></h5>
                                    <p class="text-muted">Fill in all fields</p>


                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            <label for="firstName">The MPESA CONFIRMATION CODE</label>
                                            <input type="text" placeholder="CONFIRMATION CODE" name="confirmation_code"
                                                   required
                                    ...
                                    <p>If your confirmation code and the customer's code match, the request will be
                                        confirmed and added to the list of requests</p>
